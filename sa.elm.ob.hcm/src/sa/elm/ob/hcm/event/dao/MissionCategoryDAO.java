...
public interface MissionCategoryDAO {
	 ...
	 * @param user
	 */
	void insertMisCatEmployeeUsingPrd(EHCMMisCatPeriod misCategoyPrd, User user, Boolean refreshEmployee) throws Exception;
	 ...
	 * @return
	 */
	boolean checkCategoryAlreadyAdded(String categoryId, EHCMMisEmpCategory misEmpCategoy) throws Exception;
	 ...
	 * @return
	 */
	EHCMMiscatEmployee getEmployeeinPeriod(EHCMMisCatPeriod misEmpCategoyPeriod, String employeeId) throws Exception;
	 ...
	 * @return
	 */
	boolean chkAnyEmployeeUsedDaysGrtZero(EHCMMisCatPeriod misEmpCategoyPeriod, EHCMMisEmpCategory misEmpCategory) throws Exception;

	/**
	 * in country window if we change no of after and before then update to city
	 * no of after & before
	 * 
	 * @param countryId
	 * @param noofdaysAfter
	 ...
	 * @param category
	 */
	void updateNoofDaysAfterBefore(String countryId, Long noofdaysAfter, Long noofdaysBefore, String category) throws Exception;

	/**
	 * if category will delete then remove all mission category employee for
	 * that categoy from the recent period
	 * 
	 * @param misEmpCategoyPeriod
	 * @param misEmpCategory
	 */

	void deleteMisCatEmployee(EHCMMisCatPeriod misEmpCategoyPeriod, EHCMMisEmpCategory misEmpCategory) throws Exception;
