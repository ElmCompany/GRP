    ...
    try {
      ...
      if (lastfieldChanged.equals("inpehcmEmpPerinfoId")) {
        ...
        if (empinfo != null) {
           ...
           */
          /*
           * info.addResult("inpnewDepartmentId", empinfo.getPosition().getDepartment().getId()); if
           * (empinfo.getPosition() != null && empinfo.getPosition().getSection() != null) {
      ...
      if (lastfieldChanged.equals("inpnewGradeId") || lastfieldChanged.equals("inpehcmEmpPerinfoId")
         ...
         * 
         * if (inpdecisionType.equals(DecisionTypeConstants.DECISION_TYPE_CREATE)) { sql += " and ";
         * } if (inpdecisionType.equals(DecisionTypeConstants.DECISION_TYPE_UPDATE)) { sql +=
         * " and ( "; }
         * 
         * sql +=
         ...
         * pos.getJOBNo()); log4j.debug("entered new  pos.getJOBNo(): " + pos.getJOBNo()); } } else
         * { info.addResult("inpnewEhcmPositionId", ""); info.addResult("inpnewJobTitle", "");
